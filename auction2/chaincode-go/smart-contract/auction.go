...
// InitializeAssets adds a base set of assets to the ledger
func (s *SmartContract) InitializeAssets(ctx contractapi.TransactionContextInterface) error {
	assets := []Asset{
		{ID: "org1", bidValue: 0},
		{ID: "org2", bidValue: 0},
		{ID: "org3", bidValue: 0},
...
// SubmitBid
func (s *SmartContract) SubmitBid(ctx contractapi.TransactionContextInterface, id string, bidValue int) error {
...
// DeclareWinner compares all assets found in world state and reveal the highest bidder
func (s *SmartContract) DeclareWinner(ctx contractapi.TransactionContextInterface) ([]*Asset, error) {
